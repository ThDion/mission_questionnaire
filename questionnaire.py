...
class Question:
    ...
    def from_json_data(data):
        ...
        #Si aucun bonne réponse ou plusieurs bonnes réponses - > Anomalie dans les données
...
class Questionnaire:
    ...
    def from_json_data(data):
        ...
        #Supprime les questions None qui n'ont pas être crées
    ...
    def lancer(self):
        ...
        for i in range(nb_questions):
            question = self.questions[i] #for question in self.questions:
